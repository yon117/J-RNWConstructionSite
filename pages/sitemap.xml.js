...
const STATIC_URLS = [
    ...
    { loc: `${BASE_URL}/services/mold`, priority: '0.85', changefreq: 'monthly' },
    { loc: `${BASE_URL}/services/structural-support-repair`, priority: '0.85', changefreq: 'monthly' },
    { loc: `${BASE_URL}/privacy-policy`, priority: '0.3', changefreq: 'yearly' },
    { loc: `${BASE_URL}/terms-of-use`, priority: '0.3', changefreq: 'yearly' },
    { loc: `${BASE_URL}/waterproofing-portland`, priority: '0.85', changefreq: 'monthly' },
    { loc: `${BASE_URL}/waterproofing-hillsboro`, priority: '0.85', changefreq: 'monthly' },
    { loc: `${BASE_URL}/structural-repair-portland`, priority: '0.85', changefreq: 'monthly' },
    { loc: `${BASE_URL}/general-contractor-hillsboro`, priority: '0.85', changefreq: 'monthly' },
    { loc: `${BASE_URL}/waterproofing-beaverton`, priority: '0.85', changefreq: 'monthly' },
    { loc: `${BASE_URL}/waterproofing-tigard`, priority: '0.85', changefreq: 'monthly' },
    { loc: `${BASE_URL}/structural-repair-gresham`, priority: '0.85', changefreq: 'monthly' },
    { loc: `${BASE_URL}/structural-repair-beaverton`, priority: '0.85', changefreq: 'monthly' },
    { loc: `${BASE_URL}/general-contractor-lake-oswego`, priority: '0.85', changefreq: 'monthly' },
