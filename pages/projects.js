...
const FILTERS = [
    ...
    { id: 'dry-rot',      labelKey: 'filterDryRot',      label: 'Dry Rot' },
    ...
    useEffect(() => {
        ...
        mm.add('(prefers-reduced-motion: no-preference) and (min-width: 769px)', () => {
            ...
            cards.forEach((card, i) => {
                const skewDir = i % 2 === 0 ? 10 : -10;

                // Enter: bottom of viewport → center (tilt forward into view)
                const enterTrigger = gsap.fromTo(card,
                    {
                        rotationX: 70,
                        skewX: skewDir,
                ...
                // Exit: center → top of viewport (tilt back out)
                const exitTrigger = gsap.fromTo(card,
                    {
                        rotationX: 0,
                        skewX: 0,
                        filter: 'blur(0px) brightness(1)',
                ...
                allTriggers.push(enterTrigger, exitTrigger);
            });

            return () => allTriggers.forEach(t => t.scrollTrigger?.kill());
        });
        ...
        >
            <div className={pageStyles.projectsPage}>
                <div className={pageStyles.projectsContent}>
                    ...
                    {/* ── PROJECTS GRID ── */}
                    <div ref={gridRef} className={pageStyles.projectsGrid}>
                        {filteredProjects.map((project, index) => (
                            <article
                                key={project.id}
                                data-tilt-card
                                className={pageStyles.projectCard}
                            ...
                            >
                                ...
                                <div className={pageStyles.projectOverlay}>
                                    ...
                                    <div className={pageStyles.projectDescription}>
