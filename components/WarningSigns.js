...
const WARNINGS = [
  {
    ...
    evidence: { code: 'WS-MOISTURE-01', img: '/assets/ws-ceiling-stains.jpg', tools: ['Non-invasive moisture testing', 'Thermal imaging of wet areas'] },
  },
  {
    ...
    evidence: { code: 'WS-FLOOR-02', img: '/assets/ws-floor-rot.jpg', tools: ['Subfloor moisture probe', 'Structural load assessment'] },
  },
  {
    ...
    evidence: { code: 'WS-EMERG-03', img: '/assets/ws-flooding.jpg', tools: ['Commercial water extraction', 'Industrial drying equipment'] },
  },
  {
    ...
    evidence: { code: 'WS-BATH-04', img: '/assets/ws-bathroom-mold.jpg', tools: ['Air quality sampling', 'Mold species identification'] },
  },
  {
    ...
    evidence: { code: 'WS-SIDING-05', img: '/assets/ws-siding-rot.jpg', tools: ['Probe testing for rot depth', 'Moisture content readings'] },
  },
];
